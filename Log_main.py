...
# Initialize list to store finger counts
gesture_log = []
last_finger_count = None  # Track last finger count to avoid duplicates
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        # Log finger count if it’s valid and different from the last one
        if fingerCount in sounds_mapping and fingerCount != last_finger_count:
            gesture_log.append(fingerCount)
...
# Display the logged gestures
print("Logged gestures (finger counts):", gesture_log)